...
impl PaperTradingAnalytics {
    ...
    pub fn record_trade_execution(&mut self, result: &SimulatedTradeResult, dex_name: &str) {
        ...
        self.avg_execution_time_ms =
            (total_time + result.execution_time_ms as f64) / self.opportunities_executed as f64;
        ...
        self.avg_slippage_bps =
            (total_slippage + result.slippage_bps as f64) / self.opportunities_executed as f64;
    ...
    pub fn update_from_portfolio(&mut self, summary: &PortfolioSummary) {
        ...
        if self.uptime_seconds > 0 {
            self.trades_per_hour =
                (summary.total_trades as f64) * 3600.0 / (self.uptime_seconds as f64);
        }
    ...
    fn update_dex_performance(&mut self, dex_name: &str, result: &SimulatedTradeResult) {
        ...
        perf.avg_slippage_bps =
            (total_slippage + result.slippage_bps as f64) / perf.trades_executed as f64;

        let total_time = perf.avg_execution_time_ms * (perf.trades_executed - 1) as f64;
        perf.avg_execution_time_ms =
            (total_time + result.execution_time_ms as f64) / perf.trades_executed as f64;
