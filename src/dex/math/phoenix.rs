...
mod tests {
    ...
    fn create_test_order_book() -> (Vec<OrderBookLevel>, Vec<OrderBookLevel>) {
        let bids = vec![
            OrderBookLevel { price: 199_500_000, size: 1_000_000 }, // $199.50
            OrderBookLevel { price: 199_000_000, size: 2_000_000 }, // $199.00
            OrderBookLevel { price: 198_500_000, size: 1_500_000 }, // $198.50
        ];
        
        let asks = vec![
            OrderBookLevel { price: 200_500_000, size: 1_000_000 }, // $200.50
            OrderBookLevel { price: 201_000_000, size: 2_000_000 }, // $201.00
            OrderBookLevel { price: 201_500_000, size: 1_500_000 }, // $201.50
        ];
    ...
    fn test_price_impact_calculation() {
        ...
        let impact = calculate_order_book_price_impact(
            1_000_000,
            &asks,
            mid_price,
        ).unwrap();
    ...
    fn test_optimal_order_size() {
        ...
        let optimal_size = calculate_optimal_order_size(
            &asks,
            mid_price,
            max_impact_bps,
        ).unwrap();
