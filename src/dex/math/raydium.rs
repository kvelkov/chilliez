...
pub fn calculate_raydium_swap_output(
    ...
    let fee_amount_u64 = fee_amount.to_u64()
        .ok_or_else(|| anyhow!("Fee calculation overflow"))?;
        
    let output_amount_u64 = output_amount.to_u64()
    ...
    let price_after = (new_output_reserve.to_f64().unwrap_or(0.0)) / (new_input_reserve.to_f64().unwrap_or(1.0));
...
pub fn calculate_raydium_input_for_output(
    ...
    let _required_input_u64 = required_input.to_u64()
...
mod tests {
    ...
    fn test_pool_validation() {
        ...
        assert!(validate_pool_state(1_000_000, 1_000_000, 10000, 10000).is_err()); // 100% fee
    }
