...
impl SimulatedExecutionEngine {
    ...
    pub async fn simulate_arbitrage_execution(
        ...
        let (simulated_output, actual_slippage) =
            self.calculate_simulated_output(expected_output_lamports, input_amount_lamports);
    ...
    pub async fn simulate_swap_execution(
        ...
        let (simulated_output, actual_slippage) =
            self.calculate_simulated_output(expected_output, input_amount);
