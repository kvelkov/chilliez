...
async fn test_lifinity_swap_instruction() -> Result<()> {
    ...
    println!("Lifinity instruction created with {} accounts", instruction.accounts.len());
...
async fn test_lifinity_math_with_oracle() -> Result<()> {
    ...
    println!("Lifinity with oracle: {} input -> {} output", input_amount, output);
...
async fn test_lifinity_math_without_oracle() -> Result<()> {
    ...
    println!("Lifinity without oracle: {} input -> {} output", input_amount, output);
...
async fn test_proactive_market_making() -> Result<()> {
    ...
    let output_no_oracle = calculate_lifinity_output(
        input_amount,
        input_reserve,
        output_reserve,
        fee_bps,
